...
SpotLight &SpotLight::operator=(const DirectionalLight &light) noexcept {
  BaseLight::operator=(dynamic_cast<const BaseLight &>(light));
...
SpotLight &SpotLight::operator=(const SpotLight &light) noexcept {
  BaseLight::       operator=(dynamic_cast<const BaseLight &>(light));
  DirectionalLight::operator=(dynamic_cast<const DirectionalLight &>(light));
  PointLight::      operator=(dynamic_cast<const PointLight &>(light));
...
SpotLight &SpotLight::operator=(SpotLight &&light) noexcept {
  BaseLight::       operator=(dynamic_cast<BaseLight &&>(light));
  DirectionalLight::operator=(dynamic_cast<DirectionalLight &&>(light));
  PointLight::      operator=(dynamic_cast<PointLight &&>(light));
