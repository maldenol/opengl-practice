...
// Default constructor
BaseLight::BaseLight() noexcept : Component{ComponentType::Light} {
  createShadowMapFramebuffer(_shadowMapFBO, _shadowMapTexture);
}

// Parameterized constructor
BaseLight::BaseLight(const glm::vec3 &color) noexcept
    : Component{ComponentType::Light}, _color{color} {
  createShadowMapFramebuffer(_shadowMapFBO, _shadowMapTexture);
}

// Copy constructor
BaseLight::BaseLight(const BaseLight &light) noexcept
    : Component{dynamic_cast<const Component &>(light)}, _color{light._color} {
  createShadowMapFramebuffer(_shadowMapFBO, _shadowMapTexture);
}

// Copy assignment operator
BaseLight &BaseLight::operator=(const BaseLight &light) noexcept {
  Component::operator=(dynamic_cast<const Component &>(light));
...
BaseLight::BaseLight(BaseLight &&light) noexcept
    : Component{dynamic_cast<Component &&>(light)},
...
BaseLight &BaseLight::operator=(BaseLight &&light) noexcept {
  Component::operator=(dynamic_cast<Component &&>(light));
